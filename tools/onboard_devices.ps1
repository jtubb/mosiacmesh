...
$DEFAULT_TWEAKS = @(
    ...
    # (per-device media cache: formerly 'lighttpd'; removed 2026-07-09 --
    # cache serving is now the mmcache tweak's MosaicMeshCache/ dir +
    # mmvideo's mm_url_to_path; no on-device web server needed)
...
foreach ($h in $targets) {
    ...
    # 5.4d+e removed 2026-07-09: cache serving is now the mmcache tweak's
